...
CREATE TABLE `package` (
  ...
  `type_of_tour` varchar(50) DEFAULT NULL,
  `package_pic` varchar(255) DEFAULT NULL,
  `duration` varchar(50) DEFAULT NULL,
  `meals` varchar(100) DEFAULT NULL,
  `tour_details_1` text DEFAULT NULL,
  `tour_details_2` text DEFAULT NULL,
  `tour_details_3` text DEFAULT NULL,
...
CREATE TABLE `product` (
  ...
  `color_available` varchar(100) DEFAULT NULL,
