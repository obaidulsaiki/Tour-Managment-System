...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO package (package_name, type_of_tour, package_pic, duration, meals, tour_details_1, tour_details_2, tour_details_3, `include`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssssssss", $package_name, $type_of_tour, $package_pic, $duration, $meals, $tour_details_1, $tour_details_2, $tour_details_3, $include);
...
<div class="container mt-5">
  ...
  <div class="col-md-10 col-lg-8 mx-auto">
    <div class="card p-4 rounded-4">
      <h3 class="text-center text-white mb-4">➕ Add New Tour Package</h3>
      <form method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <select name="type_of_tour" class="form-select" required>
            ...
            <option class="text-dark" value="Long">Long</option>
            <option class="text-dark" value="Day Long">Day Long</option>
          </select>
        </div>

        <div class="mb-3">
          <label class="form-label text-white">Upload Package Image</label>
        ...
        <div class="mb-3">
          ...
          <textarea name="meals" class="form-control" rows="2" required></textarea>
        </div>

        <div class="mb-3">
          <label class="form-label text-white">Tour Details 1</label>
          <textarea name="tour_details_1" class="form-control" rows="2"></textarea>
        </div>

        <div class="mb-3">
          <label class="form-label text-white">Tour Details 2</label>
          <textarea name="tour_details_2" class="form-control" rows="2"></textarea>
        </div>

        <div class="mb-3">
          <label class="form-label text-white">Tour Details 3</label>
          <textarea name="tour_details_3" class="form-control" rows="2"></textarea>
        </div>

        <div class="mb-3">
          <label class="form-label text-white">Includes</label>
          <textarea name="include" class="form-control" rows="2"></textarea>
        </div>

        <button type="submit" class="btn btn-success w-100 fw-bold">Add Package</button>
      </form>
    </div>
  </div>
</div>
